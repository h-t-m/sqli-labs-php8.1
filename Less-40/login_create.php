...
?>
<div align="right">
    <a style="font-size:.8em;color:#FFFF00" href='index.php'><img src="../images/Home.png" height='45' ;
                                                                  width='45'></br>HOME</a>
</div>
<?php
...
# Validating the user input........
    ...
    $username = mysqli_escape_string($GLOBALS['con'], $_POST['username']);
    $pass = mysqli_escape_string($GLOBALS['con'], $_POST['password']);
    $re_pass = mysqli_escape_string($GLOBALS['con'], $_POST['re_password']);
